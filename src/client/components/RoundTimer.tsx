      ...
      <div className="mt-3 flex items-baseline justify-between">
        ...
        >
          {/* Ceil so the count reaches zero exactly when answers stop being
              ...
              still are. The Match's own count-in is a screen of its own and
              never reaches this slot; what does is the short beat every other
              Round opens with, which shows the window still whole. */}
          {idle
